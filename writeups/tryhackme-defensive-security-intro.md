...
Questions & Answers
QuestionAnswerWhich team focuses on defensive security?Blue TeamWhat team monitors networks for malicious events?Security Operations CenterWhat does DFIR stand for?Digital Forensics and Incident ResponseWhich malware requires payment to restore file access?RansomwareSIEM simulation flagTHM{THREAT-BLOCKED}
